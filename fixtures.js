...
{ name: "test-app", public: true, type: "importer", gitUrl: "https://github.com/scraperwiki/test-app-tool.git", manifest: { description: "Test app", displayName: "Test app", color: "#b0df18", icon: "https://s3-eu-west-1.amazonaws.com/sw-icons/tool-icon-test.png" } },
{ name: "test-plugin", public: true, type: "view", gitUrl: "https://github.com/scraperwiki/test-plugin-tool.git", manifest: { description: "Test plugin", displayName: "Test plugin", color: "#b0df18", icon: "https://s3-eu-west-1.amazonaws.com/sw-icons/tool-icon-test.png" } },
{ name: "test-push", public: true, type: "importer", gitUrl: "https://github.com/scraperwiki/test-push-tool.git", manifest: { description: "Test push", displayName: "Test push", color: "#b0df18", icon: "https://s3-eu-west-1.amazonaws.com/sw-icons/tool-icon-test.png" } },
...
"views":[]},
{ "box" : "chris", "tool": "just-testing-identd",
"displayName":"chris", "user": "chris", boxServer: "localhost",
"views":[]},
{ "box" : "3006375730", "tool": "test-app", "displayName" : "Cheese", "user" : "ickletest", "boxServer": "localhost", "views" : [] },
{ "box" : "3006375731", "tool": "test-app", "displayName" : "Apricot", "createdDate": "2013-07-12T09:23:36.113Z", "user" : "ehg", "creatorShortName" : "ehg", "creatorDisplayName": "Chris Blower", "boxServer": "localhost", "views" : [ { "name": "downloader", "displayName": "Download a Spreadsheet", "box": "4001815731", "state": "state", "boxServer": "localhost", "tool": "spreadsheet-download" }] },
{ "box" : "3006375815", "tool": "test-app", "displayName" : "Prune", "createdDate": "2013-07-13T09:23:36.113Z", "user" : "ehg", "creatorShortName" : "ehg", "creatorDisplayName": "Chris Blower","boxServer": "localhost",  "views" : [  { "name": "prune-graph", "displayName": "Graph of Prunes", "box": "4008115731", "boxServer": "localhost", "state": "state", "tool": "prune-graph" }, { "name": "newview", "displayName": "Data Scientist's Report", "box": "4028374628", "boxServer": "localhost", "state": "state", "tool": "newview" } ] },
